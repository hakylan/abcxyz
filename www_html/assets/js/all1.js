/*1392573664,173084969,JIT Construction: v1124899,en_GB*/
/**
...
try {
    window.FB || (function (window) {
        ...
        __d("sdk.XD", ["sdk.Content", "sdk.createIframe", "sdk.Event", "guid", "Log", "QueryString", "Queue", "sdk.RPC", "sdk.Runtime", "UrlMap", "URL", "XDM", "XDConfig"], function (a, b, c, d, e, f) {
            ...
            function ia(ma, na) {
                if (na && na !== 'native' && !q(na).isFacebookURL()) return;
                if (typeof ma == 'string') {
                    if (/^FB_RPC:/.test(ma)) {
                ...
                if (!na)
                    if (ma.xd_sig == y) na = ma.xd_origin;
                if (ma.xd_action) {
                    ha(ma, na);
                    return;
                }
            ...
            function ja(ma, na) {
                if (ma == 'facebook') {
                    ...
                    if (oa) {
                        ...
                        (oa.protocol == 'https' ? v : u).enqueue(na);
                    } else {
            ...
            n.getOutQueue().start(function (ma) {
            ...
            var g = b('sdk.Anim'),
                ...
                x = n.extend({
                    ...
                    _renderConnectBar: function (y) {
                        ...
                        m.html(z, q('<div class="fb_buttons">' + '<a href="#" class="fb_bar_close">' + '<img src="{1}" alt="{2}" title="{2}"/>' + '</a>' + '</div>' + '<a href="{7}" class="fb_profile" target="_blank">' + '<img src="{3}" alt="{4}" title="{4}"/>' + '</a>' + '{5}' + ' <span>' + '<a href="{8}" class="fb_learn_more" target="_blank">{6}</a> &ndash; ' + '<a href="#" class="fb_no_thanks">{0}</a>' + '</span>', t.tx._("No, thanks"), v.resolve('fbcdn') + '/' + k.imgs.buttonUrl, t.tx._("Close"), y[this._picFieldName] || v.resolve('fbcdn') + '/' + k.imgs.missingProfileUrl, o(y.first_name), t.tx._("Hi {firstName}. \u003Cstrong>{siteName}\u003C\/strong> is using Facebook to personalise your experience.", {
