/*1388721856,180777039,JIT Construction: v1066715,vi_VN*/
/**
            ...
            var g = b('sdk.Canvas.Environment'),
                ...
                q = {
                    ...
                    _createMobileLoader: function () {
                        var r = o.nativeApp() ? '' : ('<table>' + '  <tbody>' + '    <tr>' + '      <td class="header_left">' + '        <label class="touchable_button">' + '          <input type="submit" value="' + k.tx._("H\u1ee7y") + '"' + '            id="fb_dialog_loader_close"/>' + '        </label>' + '      </td>' + '      <td class="header_center">' + '        <div>' + k.tx._("\u0110ang t\u1ea3i...") + '</div>' + '      </td>' + '      <td class="header_right">' + '      </td>' + '    </tr>' + '  </tbody>' + '</table>');
                        return q.create({
            ...
            var g = b('sdk.Anim'),
                ...
                x = n.extend({
                    ...
                    _renderConnectBar: function (y) {
                        ...
                        m.html(z, q('<div class="fb_buttons">' + '<a href="#" class="fb_bar_close">' + '<img src="{1}" alt="{2}" title="{2}"/>' + '</a>' + '</div>' + '<a href="{7}" class="fb_profile" target="_blank">' + '<img src="{3}" alt="{4}" title="{4}"/>' + '</a>' + '{5}' + ' <span>' + '<a href="{8}" class="fb_learn_more" target="_blank">{6}</a> &ndash; ' + '<a href="#" class="fb_no_thanks">{0}</a>' + '</span>', t.tx._("Kh\u00f4ng, C\u1ea3m \u01a1n"), v.resolve('fbcdn') + '/' + k.imgs.buttonUrl, t.tx._("\u0110\u00f3ng"), y[this._picFieldName] || v.resolve('fbcdn') + '/' + k.imgs.missingProfileUrl, o(y.first_name), t.tx._("Xin ch\u00e0o {firstName}. \u003Cstrong>{siteName}\u003C\/strong> hi\u1ec7n \u0111ang s\u1eed d\u1ee5ng Facebook \u0111\u1ec3 c\u00e1 nh\u00e2n h\u00f3a tr\u1ea3i nghi\u1ec7m c\u1ee7a b\u1ea1n.", {
                            firstName: o(y.first_name),
                            siteName: o(y.site_name)
                        }), t.tx._("T\u00ecm hi\u1ec3u Th\u00eam"), y.profile_url, v.resolve('www') + '/sitetour/connect.php'));
