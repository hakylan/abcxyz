...
$order_services = \OrderService::read()->andWhere("service_id=8")->orderBy("id","desc")->execute()
    ->fetchAll(\PDO::FETCH_CLASS,\OrderService::getPhpName(),array(null,false));
?>
<html>
<head>
    <title>Đơn hàng chọn DV chuyển phát nhanh</title>
    <meta charset="utf-8">
</head>
<body>
<style>
...
<h2>Thống kê đơn hàng chọn dịch vụ CPN</h2>
