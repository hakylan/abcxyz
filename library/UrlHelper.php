...
// ------------------------------------------------------------------------
     ...
     * Segments can be passed in as a string or an array, same as self::site_url
    ...
    public static function anchor($uri = '', $title = '', $attributes = '') {
        ...
        if (!is_array($uri)) {
            $site_url = preg_match('#^(\w+:)?//#i', $uri) ? $uri : self::site_url($uri);
        } else {
...
// Ref: http://www.w3schools.com/jsref/met_win_open.asp
        ...
        $attributes = self::_stringify_attributes($attributes);
...
// Reference: http://en.wikipedia.org/wiki/Post/Redirect/Get
     ...
     *
     * Helper public static function used to convert a string, array, or object of
