 ...
 * @method static \Roles[] findByLabel(string $label) find objects in database by label
 * @method static \Roles findOneByLabel(string $label) find object in database by label
 * @method static \Roles retrieveByLabel(string $label) retrieve object from poll by label, get it from db if not exist in poll

 * @method void setState(string $state) set state value
 * @method string getState() get state value
 * @method static \Roles[] findByState(string $state) find objects in database by state
 * @method static \Roles findOneByState(string $state) find object in database by state
 * @method static \Roles retrieveByState(string $state) retrieve object from poll by state, get it from db if not exist in poll
 ...
 * @method static \Roles[] findByCreatedTime(\Flywheel\Db\Type\DateTime $created_time) findByCreatedTime(string $created_time) find objects in database by created_time
 * @method static \Roles findOneByCreatedTime(\Flywheel\Db\Type\DateTime $created_time) findOneByCreatedTime(string $created_time) find object in database by created_time
 * @method static \Roles retrieveByCreatedTime(\Flywheel\Db\Type\DateTime $created_time) retrieveByCreatedTime(string $created_time) retrieve object from poll by created_time, get it from db if not exist in poll
 ...
 * @method static \Roles[] findByModifiedTime(\Flywheel\Db\Type\DateTime $modified_time) findByModifiedTime(string $modified_time) find objects in database by modified_time
 * @method static \Roles findOneByModifiedTime(\Flywheel\Db\Type\DateTime $modified_time) findOneByModifiedTime(string $modified_time) find object in database by modified_time
 * @method static \Roles retrieveByModifiedTime(\Flywheel\Db\Type\DateTime $modified_time) retrieveByModifiedTime(string $modified_time) retrieve object from poll by modified_time, get it from db if not exist in poll
